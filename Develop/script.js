...
var generatePassword = function() {
   ...
   userInput = ""; // generate password based on criteria
   finalPassword = ""; // store temporaly a random passoword.
   displayPassword = ""; // display the final password on the text area of the HTML element.

// notify user of criterias //
    ...
    for (var i = 0; i < userInput.length; i++) {
      ...
      switch(inputCriteriaInteger) { 
        ...
        case 4:
          ...
          break;
        default: 
          if (!inputCriteriaInteger) { // criteria //
...
function generatePasswordRandomness(userInput, pLenght) {
  ...
  return finalPassword; // final password
}
